!(function (e, t) {
  ...
  function X(e, t) {
    ...
    for (n in t)
      c(t, n) &&
        (F(e[n]) && F(t[n]) ? ((s[n] = {}), E(s[n], e[n]), E(s[n], t[n])) : null != t[n] ? (s[n] = t[n]) : delete s[n]);
  ...
  function fe(e, t, n) {
    e.isValid() &&
      ...
      ("FullYear" === t && he(e.year()) && 1 === e.month() && 29 === e.date()
        ? ((n = g(n)), e._d["set" + (e._isUTC ? "UTC" : "") + t](n, e.month(), We(n, e.month())))
    ...
    if (((t.abbr = e), null != R[e]))
      ...
      if (null != R[t.parentLocale]) s = R[t.parentLocale]._config;
        ...
        if (null == (n = dt(t.parentLocale)))
          return ut[t.parentLocale] || (ut[t.parentLocale] = []), ut[t.parentLocale].push({ name: e, config: t }), null;
        s = n._config;
      }
    return (
      (R[e] = new K(X(s, t))),
          ...
          e._w &&
            ...
            a < 1 || a > P(r, u, l)
              ...
              : null != h
                ...
                : ((d = $e(r, a, o, u, l)), (s._a[Y] = d.year), (s._dayOfYear = d.dayOfYear))),
          null != e._dayOfYear &&
            ((i = bt(e._a[Y], n[Y])),
  ...
  function Tt(e) {
    if (e._f === f.ISO_8601) St(e);
      ...
      for (
        ...
        (n = l[d]),
          (t = (a.match(Oe(n, e)) || [])[0]) &&
            (0 < (s = a.substr(0, a.indexOf(t))).length && m(e).unusedInput.push(s),
            ...
            null !== (t = vt.exec(n._i))
              ...
              : (St(n),
                !1 === n._isValid &&
                  ...
                  Ot(n),
                  !1 === n._isValid &&
                    (delete n._isValid, n._strict ? (n._isValid = !1) : f.createFromInputFallback(n)))))
          : a(r)
  ...
  function Vt(e, t) {
    ...
    return null === t
      ? null
      : 0 === (t = 60 * (e = ((t[t.length - 1] || []) + "").match(Lt) || ["-", 0, 0])[1] + g(e[2]))
        ? 0
        : "+" === e[0]
          ? t
          : -t;
    ...
    (i.parseZone = function () {
      ...
      return (
        null != this._tzm
          ...
          : "string" == typeof this._i && (null != (e = Vt(Se, this._i)) ? this.utcOffset(e) : this.utcOffset(0, !0)),
        this
      );
    }),
  ...
  (w.calendar = function (e, t, n) {
    ...
    (w.months = function (e, t) {
      return e
        ? (a(this._months)
            ? this._months
            : this._months[(this._months.isFormat || He).test(t) ? "format" : "standalone"])[e.month()]
        : a(this._months)
          ? this._months
    ...
    (w.monthsShort = function (e, t) {
      return e
        ? (a(this._monthsShort) ? this._monthsShort : this._monthsShort[He.test(t) ? "format" : "standalone"])[
            e.month()
          ]
        : a(this._monthsShort)
          ? this._monthsShort
  ...
  function yn(e, t, n, s) {
    t = C(t, n);
    return (
      (e._milliseconds += s * t._milliseconds), (e._days += s * t._days), (e._months += s * t._months), e._bubble()
    );
  }
  function gn(e) {
  ...
  function bn(e, t, n, s) {
    var i = C(e).abs(),
      ...
      r =
        ...
        (u < n.d && ["dd", u]);
    return (
      ((r = (r = null != n.w ? r || (h <= 1 && ["w"]) || (h < n.w && ["ww", h]) : r) ||
        (l <= 1 && ["M"]) ||
        (l < n.M && ["MM", l]) ||
        (i <= 1 && ["y"]) || ["yy", i])[2] = t),
      (r[3] = 0 < +e),
  ...
  return (
    ...
    (U.valueOf = function () {
      return this.isValid()
        ? this._milliseconds + 864e5 * this._days + (this._months % 12) * 2592e6 + 31536e6 * g(this._months / 12)
        : NaN;
    }),
    (U._bubble = function () {
