...
Readability.prototype = {
  ...
  _getArticleMetadata: function (jsonld) {
    ...
    metadata.fileName = jsonld.fileName || values["og:url"];

    if (!metadata.fileName) {
      let trimmedUrl = this._doc.baseURI.replace(/^https?:\/\/[^\/]+\//, "");
      ...
      // Replace slashes with hyphens and remove non-alphanumeric characters
      ...
      metadata.fileName = metadata.fileName.toLowerCase().replace(/-/g, "_");
  ...
  parse: function () {
    ...
    return {
      ...
      lsLocation: metadata.lsLocation,
