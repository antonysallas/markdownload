  ...
  if ("undefined" == typeof browser || Object.getPrototypeOf(browser) !== Object.prototype) {
    ...
    a.exports = ((a) => {
      ...
      const j = (a, b = {}, c = {}) => {
          ...
          return new Proxy(e, {
            ...
            get(e, f) {
              ...
              } else if ("object" == typeof k && null !== k && (i(b, f) || i(c, f))) k = j(k, b[f], c[f]);
        ...
        l = new c((a) =>
          "function" == typeof a
            ? function (b) {
                const c = j(b, {}, { getContent: { minArgs: 0, maxArgs: 0 } });
                a(c);
              }
            : a
        );
      ...
      const n = new c((a) =>
        ...
        o = ({ reject: b, resolve: c }, d) => {
          a.runtime.lastError
            ? a.runtime.lastError.message === "The message port closed before a response was received."
              ? c()
        ...
        p = (a, b, c, ...d) => {
          ...
          return new Promise((a, b) => {
            const e = o.bind(null, { resolve: a, reject: b });
        ...
        q = {
          ...
          runtime: {
            onMessage: k(n),
            onMessageExternal: k(n),
            sendMessage: p.bind(null, "sendMessage", { minArgs: 1, maxArgs: 3 }),
          },
      ...
      return (b.privacy = { network: { "*": r }, services: { "*": r }, websites: { "*": r } }), j(a, q, b);
    })(chrome);
