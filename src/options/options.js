...
const saveOptions = (e) => {
	...
	options = {
		...
		mdAssetsFolder: document.querySelector("[name='mdAssetsFolder']").value,
...
const setCurrentChoice = (result) => {
	...
	document.querySelector("[name='mdAssetsFolder']").value = result.mdAssetsFolder;
...
const loaded = () => {
	document
		.querySelectorAll(".radio-container,.checkbox-container,.textbox-container,.button-container")
		.forEach((container) => {
